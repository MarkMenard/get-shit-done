...
Template for `${planning_root}/phases/XX-name/{phase_num}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**After creation:**
- File lives in phase directory: `${planning_root}/phases/XX-name/{phase_num}-RESEARCH.md`
