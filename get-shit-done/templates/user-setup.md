...
Template for `${planning_root}/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Searchability:** `grep -r "USER-SETUP" ${planning_root}/` finds all phases with user requirements.
