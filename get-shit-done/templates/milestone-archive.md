...
This template is used by the complete-milestone workflow to create archive files in `${planning_root}/milestones/`.
...
_For current project status, see ${planning_root}/ROADMAP.md_
...
- Save to `${planning_root}/milestones/v{VERSION}-{NAME}.md`
- Example: `${planning_root}/milestones/v1.0-mvp.md`
