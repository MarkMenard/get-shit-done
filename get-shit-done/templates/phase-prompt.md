...
Template for `${planning_root}/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
```markdown
<context>
@${planning_root}/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@${planning_root}/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
<output>
After completion, create `${planning_root}/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@${planning_root}/PROJECT.md
@${planning_root}/ROADMAP.md
@${planning_root}/phases/03-features/03-01-SUMMARY.md
@${planning_root}/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `${planning_root}/phases/03-features/03-03-SUMMARY.md`
</output>
```
